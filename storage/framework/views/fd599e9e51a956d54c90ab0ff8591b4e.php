                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="text-right">
                                            <a href="#!" data-url="<?php echo e(route('charities.create')); ?>" data-size="xl" data-ajax-popup="true"
                                                class="btn btn-primary" data-bs-original-title="<?php echo e(__('Create Charities')); ?>" class="btn btn-primary" data-size="xl"
...
<script>
    ...
    $(document).on('click', '#delete_respondents', function(e) {
        e.preventDefault();
        var id = $(this).data("id");
        var url = "<?php echo e(route('charities.destroy', ':id')); ?>";
...
<?php /**PATH C:\wamp64\www\bms_new\resources\views/admin/charities/index.blade.php ENDPATH**/ ?>