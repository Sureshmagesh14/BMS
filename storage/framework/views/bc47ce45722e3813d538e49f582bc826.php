                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="text-right">
                                <a href="#!" data-url="<?php echo e(route('contents.create')); ?>" data-size="xl" data-ajax-popup="true"
                                    class="btn btn-primary" data-bs-original-title="<?php echo e(__('Create Content')); ?>" class="btn btn-primary" data-size="xl"
    ...
    <script>
                    ...
                    delete: {
                        ...
                        action: function() {
                            $.ajax({
                                ...
                                url: "<?php echo e(route('contents_multi_delete')); ?>",
                                dataType: "json",
        ...
        function datatable(){
            ...
            $('#myTable').DataTable({
                ...
                ajax: {
                    url: "<?php echo e(route('contents_datatable')); ?>",
                    data: {
                        _token: tempcsrf,
                    },
        ...
        $(document).on('click', '#delete_content', function(e) {
            e.preventDefault();
            var id = $(this).data("id");
            var url = "<?php echo e(route('contents.destroy', ':id')); ?>";
...
<?php /**PATH C:\wamp64\www\bms_new\resources\views/admin/contents/index.blade.php ENDPATH**/ ?>