                            ...
                            <div class="text-right">
                                ...
                                <div class="btn-group" role="group">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="btnGroupVerticalDrop1" style="">
                                        <a class="dropdown-item" href="<?php echo e(url('export_user_activity')); ?>">User Activity
                                            by User</a>
                                ...
                                <a href="#!" data-url="<?php echo e(route('users.create')); ?>" data-size="xl"
                                    data-ajax-popup="true" class="btn btn-primary"
                                    data-bs-original-title="<?php echo e(__('Create Users')); ?>" class="btn btn-primary"
                    ...
                    delete: {
                        ...
                        action: function() {
                            $.ajax({
                                ...
                                url: "<?php echo e(route('users_multi_delete')); ?>",
                                dataType: "json",
...
<?php /**PATH C:\wamp64\www\bms_new\resources\views/admin/users/index.blade.php ENDPATH**/ ?>