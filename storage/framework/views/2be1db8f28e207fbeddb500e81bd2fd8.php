        <div class="d-flex">
            <!-- <div class="dropdown d-inline-block language-switch">
                <button type="button" class="btn header-item waves-effect"
                    ...
                    <img id="header-lang-img" src="<?php echo e(asset('assets/images/flags/us.jpg')); ?>" alt="Header Language" height="16">
                </button>
                <div class="dropdown-menu dropdown-menu-right">
                  
                    <a href="javascript:void(0);" class="dropdown-item notify-item language" data-lang="ru">
                        <img src="<?php echo e(asset('public/assets/images/flags/russia.jpg')); ?>" alt="user-image" class="mr-1" height="12"> <span class="align-middle">Russian</span>
                    </a>
                </div>
            </div>
                ...
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                    <div class="px-lg-2">
                        <div class="row no-gutters">
                            <div class="col">
                                <a class="dropdown-icon-item" href="#">
                                    <img src="<?php echo e(asset('public/assets/images/brands/github.png')); ?>" alt="Github">
                                    <span key="t-gitHub">GitHub</span>
                                </a>
                            </div>
                            <div class="col">
                                <a class="dropdown-icon-item" href="#">
                                    <img src="<?php echo e(asset('public/assets/images/brands/bitbucket.png')); ?>" alt="bitbucket">
                                    <span key="t-bitbucket">Bitbucket</span>
                                </a>
                            </div>
                            <div class="col">
                                <a class="dropdown-icon-item" href="#">
                                    <img src="<?php echo e(asset('public/assets/images/brands/dribbble.png')); ?>" alt="dribbble">
                        ...
                        <div class="row no-gutters">
                            <div class="col">
                                <a class="dropdown-icon-item" href="#">
                                    <img src="<?php echo e(asset('public/assets/images/brands/dropbox.png')); ?>" alt="dropbox">
                                    <span key="t-dropbox">Dropbox</span>
                                </a>
                            </div>
                            <div class="col">
                                <a class="dropdown-icon-item" href="#">
                                    <img src="<?php echo e(asset('public/assets/images/brands/mail_chimp.png')); ?>" alt="mail_chimp">
                                    <span key="t-mail-chimp">Mail Chimp</span>
                                </a>
                            </div>
                            <div class="col">
                                <a class="dropdown-icon-item" href="#">
                                    <img src="<?php echo e(asset('public/assets/images/brands/slack.png')); ?>" alt="slack">
            ...
            <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                    data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img class="rounded-circle header-profile-user" src="<?php echo e(asset('public/assets/images/users/avatar-4.jpg')); ?>"
                        alt="Header Avatar">
                </button>
                <div class="dropdown-menu dropdown-menu-right">
                    <!-- item-->
                    ...
                    <a class="dropdown-item" href="<?php echo e(route('signout')); ?>"><i class="uil uil-sign-out-alt font-size-16 align-middle mr-1 text-muted"></i> <span class="align-middle" key="t-sign-out"> Sign out</span></a>
                </div>
            </div>
        </div>
    </div>
</header><?php /**PATH C:\wamp64\www\bms_new\resources\views/admin/layout/horizontal_right_menu.blade.php ENDPATH**/ ?>