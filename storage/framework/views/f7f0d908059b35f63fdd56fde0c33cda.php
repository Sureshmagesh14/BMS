                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="text-right">
                                ...
                                <a href="#!" data-url="<?php echo e(route('tags.create')); ?>" data-size="xl"
                                    data-ajax-popup="true" class="btn btn-primary"
                                    data-bs-original-title="<?php echo e(__('Create Groups')); ?>" class="btn btn-primary"
                    ...
                    delete: {
                        ...
                        action: function() {
                            $.ajax({
                                ...
                                url: "<?php echo e(route('tags_multi_delete')); ?>",
                                dataType: "json",
