                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0">Reward Details: <?php echo e($data->id); ?></h4>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-end">
                                            <button onclick="window.location='<?php echo e(route('rewards')); ?>';"
                                            ...
                                            <table class="table">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <?php echo e($data->rname); ?> - <?php echo e($data->remail); ?> - <?php echo e($data->rmobile); ?>         
                                                    </td>
                                                </tr>

                                                <tr>
                                                    <th>User</th>
                                                    <td><?php echo e($data->uname); ?>
...
<script src="<?php echo e(asset('public/assets/js/jquery.validate.js')); ?>"></script><?php /**PATH C:\wamp64\www\bms_new\resources\views/admin/rewards/view.blade.php ENDPATH**/ ?>