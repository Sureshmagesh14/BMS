                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="text-right">
                                            <a href="#!" data-url="<?php echo e(route('banks.create')); ?>" data-size="xl" data-ajax-popup="true"
                                                class="btn btn-primary" data-bs-original-title="<?php echo e(__('Create Banks')); ?>" class="btn btn-primary" data-size="xl"
...
<script>
    ...
    function datatable(){
        ...
        $('#myTable').DataTable({
            ...
            ajax: {
                url: "<?php echo e(route('get_all_banks')); ?>",
                data: {
                    _token: tempcsrf,
                },
...
<?php /**PATH C:\wamp64\www\bms_new\resources\views/admin/banks/index.blade.php ENDPATH**/ ?>