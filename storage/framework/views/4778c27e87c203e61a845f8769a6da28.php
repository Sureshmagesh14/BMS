...
<a href="#!" data-url="<?php echo e(route('export_rewards')); ?>" data-size="xl" data-ajax-popup="true"
                                        class="btn btn-primary" data-bs-original-title="<?php echo e(__('Rewards Summary')); ?>" class="btn btn-primary" data-size="xl"
...
$(document).ready(function() {
    ...
    $('#myTable').DataTable({
        ...
        ajax: {
            url: "<?php echo e(route('get_all_rewards')); ?>",
            data: {
                _token: tempcsrf,
            },
...
<?php /**PATH C:\wamp64\www\bms_new\resources\views/admin/rewards/index.blade.php ENDPATH**/ ?>