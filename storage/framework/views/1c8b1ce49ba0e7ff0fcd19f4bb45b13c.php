                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0">Content Details: <?php echo e($data->id); ?></h4>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-end">
                                            <button onclick="window.location='<?php echo e(route('contents')); ?>';"
                                                class="btn btn-secondary waves-effect" type="button">
                                                <i class="fa fa-arrow-circle-o-left"></i>
                                            </button>&nbsp;&nbsp;
                                            <button onclick="window.location='<?php echo e(route('edit_contents',['id' => $data->id])); ?>';" class="btn btn-success" id="create_another" type="button">
                                                <i class="fa fa-edit"></i>
                                            </button>&nbsp;&nbsp;
                                            <button id="delete_content" data-id="<?php echo e($data->id); ?>" class="btn btn-primary" id="create" type="button">
...
<script src="<?php echo e(asset('public/assets/js/jquery.validate.js')); ?>"></script><?php /**PATH C:\wamp64\www\bms_new\resources\views/admin/contents/view.blade.php ENDPATH**/ ?>