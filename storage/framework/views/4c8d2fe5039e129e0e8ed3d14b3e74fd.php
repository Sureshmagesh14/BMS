    ...
    <div class="page-content">
        ...
        <script>
            ...
            $("#create").click(function(e) {
                ...
                $.ajax({
                    type: 'post',
                    url: "<?php echo e(route('save_network')); ?>",
                    data: data,
                    headers: {
            ...
            $("#create_another").click(function(e) {
                ...
                $.ajax({
                    type: 'post',
                    url: "<?php echo e(route('save_contents')); ?>",
                    data: data,
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                    },
...
<?php /**PATH C:\wamp64\www\bms_new\resources\views/admin/networks/create.blade.php ENDPATH**/ ?>