            ...
            <div class="row">
                ...
                <div class="col-xl-3 col-md-6">
                    <div class="py-lg-2 pl-lg-2">
                        <img src="<?php echo e(asset('public/assets/images/menu-product-1.jpg')); ?>" alt="" class="img-fluid mx-auto rounded shadow">
                    </div>
                </div>
                <div class="col-xl-3 col-md-6">
                    <div class="py-lg-2 pr-lg-2">
                        <img src="<?php echo e(asset('public/assets/images/menu-product-2.jpg')); ?>" alt="" class="img-fluid mx-auto rounded shadow">
                    </div>
                </div>
            </div>
        </div>
...
</div><?php /**PATH C:\wamp64\www\bms_new\resources\views/admin/layout/horizontal_left_menu.blade.php ENDPATH**/ ?>