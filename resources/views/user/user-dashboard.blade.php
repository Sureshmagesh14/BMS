...
<section class="">
    <div class="container-fluid">
        ...
        @if ($data->active_status_id == 1 && $data->profile_completion_id == 0)
        <div class="alert alert-danger bs-alert-old-docs text-center">
            ...
            <small class="leading-none mt-1 text-danger">
                Cash Outs and Surveys are available if your profile is up to date. Please update your profile.
            </small>
        </div>
        ...
        @elseif ($data->profile_completion_id == 1)
            <div class="alert alert-success bs-alert-old-docs text-center">
                <strong>Your profile is complete!</strong> You are eligible for surveys and rewards.
            </div>
        @endif
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-md-12 text-center d-flex">
                                        <a href="https://mail.google.com/mail/?view=cm&fs=1&to={{ $data->email }}"
                                            ...
                                            <i class="fa fa-envelope yelow-clr pe-2" aria-hidden="true"></i>
                                            {{ $data->email }}
                                        </a>
                                    </div>
                                    <div class="col-md-12 text-center d-flex">
                                ...
                                <div class="mt-3 d-flex justify-content-center">
                                    <form method="POST" action="{{ route('logout') }}">
                                        ...
                                        <a href="{{ route('logout') }}"
                                            ...
                                            class="btn btn-yellow rounded-pill d-flex align-items-center">
                                ...
                                <div class="row">
                                    <div class="col-4 rounded ">
                                        <div class="bg-grey-6 p-2 m-2 w-100 m-h-180 rounded">
                                            <div class="bg-yellow text-white p-2 rounded mt-2 text-center m-auto">
                                                {{ $get_overrall_rewards }}</div>
                                            <div class="down-triangle-yellow triangle"></div>
                                            <div class="text-center my-2">Total Rewards Since
                                                {{ \Carbon\Carbon::now()->year }}</div>
                                        </div>
                                    </div>
                                    <div class="col-4 rounded ">
                                        <div class="bg-grey-6 p-2 m-2 w-100 m-h-180 rounded">
                                            <div class="bg-blues text-white p-2 rounded mt-2 text-center m-auto">
                                                {{ $get_current_rewards }}</div>
                                        ...
                                        <div class="row my-3">
                                            ...
                                            <div class="col-6 my-auto">
                                                @if ($data->profile_completion_id == 1)
                                                    ...
                                                    @if ($get_reward >= 40)
                                                        <a class="btn btn-yellow width-fit-content ml-auto d-flex"
                                                            id="request_press" data-url="{{ route('cashout_form') }}"
                                                            data-size="xl" data-ajax-popup="true"
                                                            data-bs-original-title="{{ __('Cashout Process') }}"
                                                            data-bs-toggle="tooltip"
                                                            data-value="{{ $get_reward }}">Request Cash Out</a>
                                                    @endif
                            ...
                            <div class="bg-white my-2 max-w-100" style="min-height: 400px;">
                                <h5 class="align-items-center justify-content-around">
                                    <div><img class="w-5 me-2 ms-3 my-3"
                                        ...
                                        <span class="small-font-sm">See if You Qualify for Research</span>
                                    </div>
                                                                ...
                                                                <div
                                                                    ...
                                                                    @if ($res->access_id == 1)
                                                                        @if (Carbon\Carbon::parse($res->created_at)->toDateString() >= '2024-08-23')
                                                                            <a
                                                                                href="{{ url('share_project', [$res->project_link, base64_encode(session('resp_id'))]) }}"><i
                                            ...
                                            @foreach ($get_paid_survey as $res)
                                                <tr>
                                                    ...
                                                    @if ($data->profile_completion_id == 0)
                                                        <td>
                                                            <a href="{{ route('updateprofile_wizard') }}">
                                                                To continue please complete your profile </a>
                                                        </td>
                                                    @else
                                                        @if ($get_link != null)
                                                            <td>
                ...
                <div class="bg-white  max-w-100">
                    <h5 class=" align-items-center justify-content-around">
                        <div class="w-50"><img class="w-5 me-2 ms-3 my-3"
                                ...
                                class="small-font-sm">Your Survey History</span> </div>
                    ...
                    <table class="table table-striped table-bordered table-hover dataTable" id="DataTables_Table_2"
                        style="width: 100%;" aria-describedby="completed_info">
                        <thead>
                            <tr>
                                <th>NAME </th>
                                <th>DATE </th>
                    ...
                    switch (label) {
                        case 'Additional Information':
                            window.location.href =
                                "{{ route('updateprofile_wizard', ['section' => 'extended']) }}";
                            break;
                        case 'Your Essential Information':
                            window.location.href =
                                "{{ route('updateprofile_wizard', ['section' => 'essential']) }}";
                            break;
                        case 'Basic':
                            window.location.href =
                                "{{ route('updateprofile_wizard', ['section' => 'basic']) }}";
                            break;
                    }
                }
            }
