...
<head>
  ...
  <link href="{{ asset('assets/css/admin/confirm.min.css') }}" id="app-style" rel="stylesheet"
    type="text/css" />
</head>
                ...
                <li>
                  <form method="POST" action="{{ route('logout') }}">
                    ...
                    <a class="dropdown-item" href="{{ route('logout') }}"
                      onclick="event.preventDefault(); this.closest('form').submit();" id="click_signout">Logout</a>
                  </form>
                </li>
              </ul>
            </li>
