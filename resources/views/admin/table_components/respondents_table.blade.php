...
<div class="text-right">
    ...
    <div class="btn-group mr-2" role="group" aria-label="First group" >
        <select name="action_2" id="action_2" class="form-control respondents_datatable hided_option respondents_select_box" style="display:none;">
            ...
            <div class="btn-group dropdown-filter">
                ...
                <div class="card">
                    <ul class="dropdown-menu dropdown-menu-right p-2">
                        <li class="mb-3">
                            <h5>Status Filter</h5>
                            <select name="filter_respondent_status" id="filter_respondent_status" class="form-control" onchange="filter_respondent_status(this)">
                        ...
                        <li class="mb-3">
                            ...
                            <select name="filter_respondent_profile" id="filter_respondent_profile" class="form-control" onchange="filter_respondent_profile(this)">
    ...
    @if (Auth::guard('admin')->user()->role_id == 1)
        <div class="btn-group respondents_datatable hided_option" role="group" aria-label="Third group" style="display: none;">
            <div class="btn-group dropdown-filter">
                <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
