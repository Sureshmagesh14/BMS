<div class="btn-toolbar float-right" role="toolbar" aria-label="Toolbar with button groups">
    <div class="btn-group mr-2" role="group" aria-label="Second group">
        <a href="#!" data-url="{{ route('banks.create') }}" data-size="xl" data-ajax-popup="true"
            class="btn btn-primary" data-bs-original-title="{{ __('Create Banks') }}" class="btn btn-primary"
            data-size="xl" data-ajax-popup="true" data-bs-toggle="tooltip" id="create">
            Create Banks
        </a>
    </div>
    <div class="btn-group banks_table hided_option" role="group" aria-label="Third group" style="display: none;">
        <div class="btn-group dropdown-filter">
            ...
            <ul class="dropdown-menu dropdown-menu-right">
                <li class="dropdown-header">
                    <a class="btn btn-danger banks_table delete_all" class="btn btn-primary">
                        Delete Selected All
                    </a>
                </li>
            </ul>
