<div class="btn-toolbar float-right" role="toolbar" aria-label="Toolbar with button groups">
    <div class="btn-group mr-2" role="group" aria-label="Second group">
        <a href="#!" data-url="{{ route('contents.create') }}" data-size="xl" data-ajax-popup="true"
            class="btn btn-primary" data-bs-original-title="{{ __('Create Content') }}" class="btn btn-primary"
            data-size="xl" data-ajax-popup="true" data-bs-toggle="tooltip" id="create">
            Create Content
        </a>
    </div>
    <div class="btn-group contents_table hided_option" role="group" aria-label="Third group" style="display: none;">
        <div class="btn-group dropdown-filter">
            ...
            <ul class="dropdown-menu dropdown-menu-right">
                <li class="dropdown-header">
                    <a class="btn btn-danger contents_table delete_all" class="btn btn-primary">
                        Delete Selected All
                    </a>
                </li>
            </ul>
