    ...
    <div class="page-content">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0">Update Content: {{$network->id}}</h4>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <form id="form-data">
                                        ...
                                        <input type="text" id="id" name="id" value="{{$network->id}}">
                                        ...
                                        <div class="d-flex justify-content-end">
                                            <button onclick="window.location='{{route('view_network',['id' => $network->id])}}';" class="btn btn-secondary waves-effect" type="button">
                                                Cancel
                                            </button>&nbsp;&nbsp;
        ...
        <script>
            ...
            $("#update").click(function(e) {
                ...
                var id=$("#id").val();
                var url = "{{ route('update_network', ':id') }}";
