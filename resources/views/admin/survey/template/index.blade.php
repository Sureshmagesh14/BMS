    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="card card-body">
                ...
                <div class="tabs">
                    <button class="tablinks activetab" onclick="openTab(event, 'activesurvey')">Active Surveys</button>
                    <button class="tablinks" onclick="openTab(event, 'closed')">Closed Surveys</button>
                </div>
                <div id="activesurvey" class="tabcontent">
                            ...
                            <div class="row no-gutters w-100 py-5 px-xl-3 ss-dashboard__list-item justify-content-between align-items-center background-color--white pointer--cursor surveyrow">
                                <div class="ss-dashboard__list-item--left col-12 col-xl-5 pe-0 pe-xl-5">
                                    <div class="d-flex align-items-center flex-wrap flex-md-nowrap">
                                        ...
                                        <a href="{{route('survey.builder',[$survey->builderID,0])}}"><h3 class="ss-text ss-text__size--h3 ss-text__weight--semibold ss-text__color--black mb--xs ss-text__overflow-wrap">{{$survey->title}}</h3></a>
...
document.addEventListener("DOMContentLoaded", function() {
    // Show active surveys tab by default
    document.getElementById("activesurvey").classList.add("show");
