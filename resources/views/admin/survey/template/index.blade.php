...
<div class="main-content1">
    <div class="page-content">
        <div class="container-fluid">
            ...
            <!-- end page title -->
            <div class="ms-3 ps-3 border-left createsurveyBtn"><a href="#" class="ss-button ss-button__primary mb--sm" data-url="{{route('survey.create')}}" id="tracking-survey__new-survey" data-ajax-popup="true" data-bs-toggle="tooltip" title="Create Survey" data-title="Create Survey"><svg width="14" height="14" class="me-3" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><g opacity="1"><line x1="10" y1="1" x2="10" y2="19" stroke="#FFFFFF" stroke-width="2" stroke-linecap="round"></line><line x1="19" y1="10.5" x2="1" y2="10.5" stroke="#FFFFFF" stroke-width="2" stroke-linecap="round"></line></g></svg>New Survey</a></div>
