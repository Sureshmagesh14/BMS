...
<a href="#!" data-url="{{ route('export_resp') }}" data-size="xl" data-ajax-popup="true"
                                        class="btn btn-primary" data-bs-original-title="{{ __('export Respondents') }}" class="btn btn-primary" data-size="xl"
