<form id="edit_respondents_form" class="validation">
    ...
    <div class="form-group row">
        ...
        <div class="col-md-10">
            <input type="text" class="form-control" id="surname" name="surname" value="{{$respondents->surname}}">
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-md-10">
            <input type="date" class="form-control" id="date_of_birth" name="date_of_birth" value="{{$respondents->date_of_birth}}">
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-md-10">
            <input type="date" class="form-control" id="id_passport" name="id_passport" value="{{$respondents->id_passport}}">
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-md-10">
            <input type="text" class="form-control" id="whatsapp" name="whatsapp" value="{{$respondents->whatsapp}}">
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-md-10">
            <input type="text" class="form-control" id="email" name="email" value="{{$respondents->email}}" required>
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-md-10">
            <input type="text" class="form-control" id="bank_name" name="bank_name" value="{{$respondents->bank_name}}" >
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-md-10">
            <input type="text" class="form-control" id="branch_code" name="branch_code" value="{{$respondents->branch_code}}" >
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-md-10">
            <input type="text" class="form-control" id="account_type" name="account_type" value="{{$respondents->account_type}}" >
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-md-10">
            <input type="text" class="form-control" id="account_holder" name="account_holder" value="{{$respondents->account_holder}}" >
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-md-10">
            <input type="text" class="form-control" id="account_number" name="account_number" value="{{$respondents->account_number}}" >
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-md-10">
            <input type="date" class="form-control" id="updated_at" name="updated_at" value="{{$respondents->updated_at}}">
        </div>
    </div>
    @php
    ...
    <div class="form-group row">
        ...
        <div class="col-md-10">
            <input type="text" class="form-control" id="" name="" value="{{$refcode}}" disabled>
            <input type="hidden" class="form-control" id="referral_code" name="referral_code" value="{{$respondents->referral_code}}" >
        </div>
    </div>
