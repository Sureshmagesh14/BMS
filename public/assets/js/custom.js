...
$(document).on("click", '.bs-pass-para-dup', function () {
    ...
    swalWithBootstrapButtons.fire({
        title: 'Are you sure?',
        text: "You want to confirm duplicate this invoice. Press Yes to continue or NO to go back",
        icon: 'warning',
...
$(document).on("click", '.bs-pass-para-duplicate', function () {
    ...
    swalWithBootstrapButtons.fire({
        title: 'Are you sure?',
        text: "It will duplicate if you take this action. Do you want to continue?",
        icon: 'warning',
        showCancelButton: true,
        confirmButtonText: 'Yes',
        cancelButtonText: 'No',
